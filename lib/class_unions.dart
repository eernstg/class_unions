...
class Union2<X1, X2> {
  ...
  const Union2.in1(X1 this.value);

  /// Create a [Union2] value from the second type argument.
  const Union2.in2(X2 this.value);
